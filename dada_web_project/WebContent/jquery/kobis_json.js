$(document).ready(function(){
	const kobis = {"boxOfficeResult":
					 ...
					 "dailyBoxOfficeList":[
						 {"rnum":"1", "rank":"1","rankInten":"0","rankOldAndNew":"OLD",
							 "movieCd":"20227890","movieNm":"슈퍼 마리오 브라더스","openDt":"2023-04-26",
							 "salesAmt":"356316803","salesShare":"27.8","salesInten":"-1398392724",
							 "salesChange":"-79.7","salesAcc":"9832497138","audiCnt":"35066",
							 "audiInten":"-151261","audiChange":"-81.2","audiAcc":"990505",
							 "scrnCnt":"1201","showCnt":"4501"},
						 {"rnum":"2","rank":"2","rankInten":"0","rankOldAndNew":"OLD",
							 "movieCd":"20198482","movieNm":"드림","openDt":"2023-04-26",
							 "salesAmt":"319364559","salesShare":"24.9","salesInten":"-681636100",
							 "salesChange":"-68.1","salesAcc":"6505746070","audiCnt":"34237",
							 "audiInten":"-72409","audiChange":"-67.9","audiAcc":"679745",
							 "scrnCnt":"1188","showCnt":"4394"},
						 {"rnum":"3","rank":"3","rankInten":"0","rankOldAndNew":"OLD",
							 "movieCd":"20231089","movieNm":"존 윅 4","openDt":"2023-04-12",
							 "salesAmt":"191853325","salesShare":"15.0","salesInten":"-435532163",
							 "salesChange":"-69.4","salesAcc":"17444892660","audiCnt":"19220",
							 "audiInten":"-45799","audiChange":"-70.4","audiAcc":"1682867",
							 "scrnCnt":"894","showCnt":"2077"},
						 {"rnum":"4","rank":"4","rankInten":"0","rankOldAndNew":"OLD",
							 "movieCd":"20226270","movieNm":"스즈메의 문단속","openDt":"2023-03-08",
							 "salesAmt":"125553887","salesShare":"9.8","salesInten":"-237306924",
							 "salesChange":"-65.4","salesAcc":"53077042996","audiCnt":"12581",
							 "audiInten":"-25817","audiChange":"-67.2","audiAcc":"5169707",
	...
	/*for(i = 0; i < boxOffice.dailyBoxOfficeList.length; i++){
		code += "<tr><td>" + boxOffice.dailyBoxOfficeList[i].rank + 
				"</td><td>" + boxOffice.dailyBoxOfficeList[i].movieNm +
				"</td><td>" + boxOffice.dailyBoxOfficeList[i].openDt +
				"</td><td>" + boxOffice.dailyBoxOfficeList[i].salesAcc +
				"</td><td>" + boxOffice.dailyBoxOfficeList[i].audiCnt +
				"</td><td>" + boxOffice.dailyBoxOfficeList[i].audiAcc +
				"</td><td>" + boxOffice.dailyBoxOfficeList[i].showCnt + "</td></tr>";
	}*/

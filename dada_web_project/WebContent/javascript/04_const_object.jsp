...
<head>
	...
	<script>
		...
		/* JSON(JavaScript Object Notation) */
 		//블레이스{}는 Json에서 사용됨 : {name: value, name:value,...} -> REST
		const json1 = {"subject1":"java", 'subject2':"oracle"}; 
		const score = {name:"홍길동", kor:100, eng:100, math:100, tot:300.0, avg:100.0}; //name 부분에 ""안붙여

		/* JSON + Array */
		const scoreList = {hong:[{name:"홍길동"}, 10, 10, 10], test:["테스트", 20, 20, 20]};
		
		//const키워드는 재정의 불가
		//const x_arr = ["java", "oracle", "html"];
		...
		document.write("json1-->" + json1 + "<br>"); //Json 객체 json1의 주소값
		...
		document.write("scoreList.test[3]-->" + scoreList.test[3] + "<br><br>");
